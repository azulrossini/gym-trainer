    ...
    return (
      <div className="workout-session min-h-screen bg-gradient-to-br from-success-50 via-white to-accent-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-12 max-w-2xl w-full text-center">
          ...
          <button
            onClick={onExit}
            className="px-8 py-3 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-lg text-lg transition-colors"
          >
            Back to Workout
          </button>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            <div className={`bg-gradient-to-r ${routineTypeColors[currentRoutine.type]} text-white rounded-xl p-6 mb-6`}>
              ...
              <div className="flex justify-between items-center">
                <span className="text-lg font-medium">{currentRoutine.type}</span>
                <span className="text-lg font-semibold">{currentRoutine.duration} min</span>
              </div>
            </div>
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex gap-3 justify-center mb-4">
                {status === 'ready' && (
                  <button
                    onClick={handleStart}
                    className="control-button px-8 py-4 bg-success-600 hover:bg-success-700 text-white font-bold rounded-lg text-xl transition-colors"
                  >
                    ▶ Start
                  </button>
                )}
                {status === 'running' && (
                  <button
                    onClick={handlePause}
                    className="control-button px-8 py-4 bg-amber-600 hover:bg-amber-700 text-white font-bold rounded-lg text-xl transition-colors"
                  >
                    ⏸ Pause
                  </button>
                )}
                ...
                {status !== 'running' && !isRoutineComplete && (
                  <button
                    ...
                    className="control-button px-6 py-4 bg-gray-400 hover:bg-gray-500 text-white font-medium rounded-lg transition-colors"
                  >
                    Skip to End
                  </button>
                )}
